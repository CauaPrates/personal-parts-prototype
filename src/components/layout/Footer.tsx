  ...
  return (
    <footer className="bg-ink-900">
      <div className="relative overflow-hidden border-b border-ink-800 bg-ink-950">
        <div className="container-px relative z-10 mx-auto flex h-24 max-w-7xl items-center sm:h-28">
          <img src="/brand/logo-footer.png" alt="Personal Parts — Performance Automotive" className="h-16 w-auto sm:h-20" />
        </div>
      ...
      <div className="container-px mx-auto max-w-7xl py-14">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="mt-5 flex gap-3">
              {[InstagramIcon, FacebookIcon, YoutubeIcon].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="flex h-9 w-9 items-center justify-center rounded border border-ink-600 text-silver-400 hover:border-verde hover:text-verde"
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-silver-400">
              <li><Link to="/sobre" className="hover:text-verde">Sobre a Personal Parts</Link></li>
              <li><Link to="/trabalhos" className="hover:text-verde">Portfólio de trabalhos</Link></li>
              <li><Link to="/revenda" className="hover:text-verde">Seja um lojista</Link></li>
              <li><Link to="/contato" className="hover:text-verde">Contato</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-silver-400">
              <li><Link to="/produtos" className="hover:text-verde">Todos os produtos</Link></li>
              <li><Link to="/produtos?categoria=cat-kits" className="hover:text-verde">Kits aerodinâmicos</Link></li>
              <li><Link to="/produtos?categoria=cat-spoilers" className="hover:text-verde">Spoilers</Link></li>
              <li><Link to="/produtos?categoria=cat-para-choques" className="hover:text-verde">Para-choques</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-silver-400">
              ...
              <li className="flex items-center gap-2">
                <Phone className="h-4 w-4 shrink-0 text-silver-400" />
                (11) 99999-9999
              </li>
              <li className="flex items-center gap-2">
        ...
        <div className="mt-10 flex flex-wrap items-center gap-4 border-t border-ink-700 pt-8">
          ...
          <div className="flex items-center gap-3">
            <div className="flex h-14 items-center overflow-hidden rounded-lg border border-ink-600 bg-silver-300 px-2.5 shadow-card">
              <img
